...
These new ‘split system combinations’ pages (e.g. [GAL4DBD.R72B05∩Hsap\RELAAD.ple](https://flybase.org/reports/FBco0000023)), include information specific to that combination. Currently these include the FlyBase identifier (FBco), synonyms, the transgenic hemidriver alleles that make up the combination, expression pattern data and links to stocks corresponding to the combination.
