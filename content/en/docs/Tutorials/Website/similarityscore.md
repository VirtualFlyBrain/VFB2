...
---
## Scores Availability
The similarity scores are calculated using [NBLAST](/docs/tutorials/apis/nblast/) or other third-party scores (e.g. [NeuronBridge](https://neuronbridge.janelia.org/)). Only queries with above-threshold scores will appear in the 'Find similar...' menu.

## Step 1: Select a Neuron or Expression Pattern

Navigate to the [VFB browser](https://v2.virtualflybrain.org/org.geppetto.frontend/geppetto) and select a neuron or expression pattern of interest so it's information is shown in the [Term Info](/docs/website-features/terminfo/) panel.
...
<p align="center">
  <img src="/images/5_Nblast_files/nblast_query_terminfo.png" alt="NBLAST query in Term Info pane." style="max-width=50%" />
</p>
