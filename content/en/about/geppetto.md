...
| [Live demo](http://live.geppetto.org) | [Paper](https://paper.geppetto.org) | [Docs](https://docs.geppetto.org/en/latest/) |
--------------------------------
...
[![Geppetto's 3D viewer showing a Drosophila brain: translucent neuropil domains in yellow with individual neuron arbors traced through them in blue](/images/geppetto/f0.png)](/images/geppetto/f0.png)
...
[![The Geppetto interface over a 3D network, with floating panels for membrane potentials of pyramidal and basket cells, a chord plot, and a colour-coded connectivity matrix](/images/geppetto/f1.png)](/images/geppetto/f1.png)
...
[![Geppetto's search box filtering model variables, autocompleting soma voltage variables over the 3D scene behind it](/images/geppetto/f2.png)](/images/geppetto/f2.png)
...
[![A 3D network model rendered as blue cylindrical cell bodies with long processes, a few highlighted in red](/images/geppetto/f4.png)](/images/geppetto/f4.png)
...
[![The Geppetto model tree in an editor, listing GeppettoModel, Node, Library and Experiment alongside the type hierarchy](/images/geppetto/f6.png)](/images/geppetto/f6.png)
...
[![WormSim in Geppetto: a 3D C. elegans body-wall model mid-crawl, with a guided-tour panel and a muscle activation trace](/images/geppetto/cn1.png)](/images/geppetto/cn1.png)

[![A single C. elegans body-wall muscle cell simulated in Geppetto, with voltage and calcium concentration plots and the model's parameter tree](/images/geppetto/cn2.png)](/images/geppetto/cn2.png)

[![The c302 C. elegans network model in Geppetto, membrane potential traces above the JavaScript console](/images/geppetto/cn3.png)](/images/geppetto/cn3.png)

[![A retinal ganglion cell reconstructed by EyeWire players, rendered in 3D in Geppetto](/images/geppetto/cn4.png)](/images/geppetto/cn4.png)

[![Virtual Fly Brain running on Geppetto: painted neuropil domains in grey and gold with individual neurons in colour](/images/geppetto/cn5.png)](/images/geppetto/cn5.png)

[![A hippocampus CA1 pyramidal cell model from Open Source Brain, its branching morphology rendered beside the biophysical parameter tree](/images/geppetto/cn6.png)](/images/geppetto/cn6.png)

[![A primary auditory cortex network model in Geppetto, with a selected basket cell, membrane potential plot and connectivity matrix](/images/geppetto/cn7.png)](/images/geppetto/cn7.png)

[![The Traub thalamocortical network model rendered in Geppetto as dense blue and yellow fibre bundles](/images/geppetto/cn8.png)](/images/geppetto/cn8.png)

### Get involved!

Help us build the next generation simulation platform!

Geppetto is entirely open source and is being built by a growing community of talented engineers and scientists. Geppetto uses different languages to achieve different goals. Geppetto runs on the Eclipse Virgo WebServer and can be deployed on different infrastructures including cloud-based ones like Amazon [EC2](https://aws.amazon.com/ec2/). 
...
| [Source code](https://git.geppetto.org) | [Docs](https://docs.geppetto.org) | [Development board](https://board.geppetto.org/)
--------------------------------
...
Computational neuroscience has produced software systems, including NEURON and Genesis, that are extremely useful for simulating systems of neurons that include biophysical details ([Brette et al, 2007](https://arxiv.org/abs/q-bio.NC/0611089)). A range of other algorithms have been devised in other areas of computational biology ([Barnes & Chu, 2010](https://doi.org/10.1007/978-1-84996-326-8)) for which simulators have been produced ([Takahashi, 2004](https://web.sfc.keio.ac.jp/%7Eshafi/takahashi-thesis.pdf)). Several investigations have pointed to the challenges in building a single system that integrates multiple simulation algorithms together into a single biological model ([Takahashi et al., 2002](https://doi.org/10.1109/MIS.2002.1039834), [Dada and Mendes, 2007](https://dx.doi.org/10.1007/978-3-642-02879-3), [Cornelis et al., 2012](https://doi.org/10.1371/journal.pone.0029018)).
...
*   [MetaCell](https://metacell.us)
*   [Wellcome Trust](https://www.wellcome.ac.uk/) via the [Open Source Brain](https://www.opensourcebrain.org/) initiative
*   [Wellcome Trust](https://www.wellcome.ac.uk/) via [Virtual Fly Brain](https://www.virtualflybrain.org/)
*   [Orion Bionetworks](https://www.orionbionetworks.org/)
...
The decision to build Geppetto came after an analysis of the requirements for a platform able to support the [OpenWorm](https://openworm.org) full-scale simulation of the C. elegans.
...
Geppetto is released under the [MIT license](https://opensource.org/licenses/MIT).

![The Geppetto mascot, a pirate holding a glowing ball of tangled string](/images/geppetto/geppetto.png) Arr, didn't find what you were looking for? Check out our [docs](https://docs.geppetto.org/en/latest/)
